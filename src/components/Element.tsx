...
import { excludedKeys, includeKeys, AnimationProps } from '../utils/constants';
...
// Fonction pour extraire les classes utilitaires basées sur les props
const extractUtilityClasses = (
  props: CssProps,
  getColor: (color: string) => string,
  mediaQueries: Record<string, string | string[]>,
  devices: Record<string, string | string[]>
): string[] => {
